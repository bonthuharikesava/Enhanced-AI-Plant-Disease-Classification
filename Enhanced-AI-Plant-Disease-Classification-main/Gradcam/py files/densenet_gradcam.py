...
Original file is located at
    https://colab.research.google.com/drive/1bZseP4mjeaW8vuL7S39pZUafUstpTOLZ
"""
...
model = load_model("/content/drive/My Drive/My_Plant_Proj/Dataset/old_3_ensemble/densenet121_fast.h5")
...
def gradcam_on_image(img_path):
    ...
    # Use the correct last convolutional layer name for DenseNet121
    heatmap = make_gradcam_heatmap(img_array, model, last_conv_layer_name="conv5_block16_2_conv")
